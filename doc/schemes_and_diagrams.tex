...
\item Functions:
  ...
  \item \texttt{wigner\_9j}$(j_1,j_2,j_3,l_1,l_2,l_3,k_1,k_2,k_3)\;=\;\wigninej{j_1}{j_2}{j_3}{l_1}{l_2}{l_3}{k_1}{k_2}{k_3}$\footnote{Integers only}
  \end{itemize}
\end{itemize}
...
\item Functions:
  ...
  \item Function: \texttt{RME\_np\_x\_Dq\_1}
  \item Function: \texttt{RME\_Qp2\_x\_Dq\_1}
  \end{itemize}
\end{itemize}
